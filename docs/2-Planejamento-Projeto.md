...
* 🗄️**Sprint 3 (Foco: Projeto da Solução, Requisitos e Banco de Dados)**
  * **Scrum Master:** Aluno K
  * **Modelador(a) de Dados (Banco de Dados):** Aluna X
  * **Analista de Requisitos (RF e RNF):** Aluna W e Aluno Y
  * **Revisor(a) Técnico(a):** Aluna Z

* ⚙️**Sprint 4 (Foco: Desenvolvimento Parcial da Aplicação)**
  * **Scrum Master:** Aluna W
  * **Desenvolvedores(as) Full-stack (Ponta a Ponta):** Aluna X, Aluno Y, Aluno K
  * **Analista de Qualidade e Testes (QA):** Aluna Z

* 🏆**Sprint 5 (Foco: Conclusão da Ferramenta e Apresentação Final)**
  * **Scrum Master:** Aluna Z
  * **Desenvolvedores(as) Full-stack (Ajustes Finais):** Aluna X, Aluno Y, Aluno K
  * **Responsável por Relatório e Apresentação:** Aluna W
...
> * **Sprint 5:** [Acesse o Quadro da Sprint 5 aqui](https://github.com/orgs/seu-grupo/projects/5)
---
